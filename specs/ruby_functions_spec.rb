...
class Functions_Practice < MiniTest::Test
  ...
  def test_volume_of_sphere()
    sphere_volume_result = sphere_volume (5)
    assert_equal( 523.6, sphere_volume_result )
  end


  def test_fahrenheit_to_celsius()
   fahrenheit_to_celsius_result = fahrenheit_to_celsius(104)
    assert_equal(40, fahrenheit_to_celsius_result)
  end
end
